...
Для использование в операционных системах семейства linux: debian, ubuntu и.т.д. - необходимо самостоятельно собрать компоненту. Это лучше всего сделать в ubuntu 20.04.
