...
| Раздел | Описание |
|--------|----------|
| [Подключение компоненты](connection.md) | Подключение компоненты на клиенте и сервере, изолированный режим, получение PID процесса (`ПолучитьИдентификаторПроцесса`) |
...
| [ACL](acl.md) | Управление списками контроля доступа (Access Control Lists) |
